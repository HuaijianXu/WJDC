...
<div>
    <table>
        ...
        <tr>
            ...
            <td><input type="text" name="name" id="name" oninput="changed('name')">请填写真实姓名以便联系您</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>通讯地址</td>
            <td>
                <input type="text"name="txdz" id="txdz" oninput="changed('txdz')">
            </td>
        </tr>
        <tr>
            <td>邮政编码</td>
            <td>
                <input type="text"name="yzbm"id="yzbm">
            </td>
        </tr>
        <tr>
            <td>手机</td>
            <td>
                <input type="text"name="yddh" id="yddh">
            </td>
        </tr>
        <tr>
            <td>固定电话</td>
            <td>
                <input type="text"name="gddh" id="gddh">
            </td>
        </tr>
        <tr>
            <td>电子信箱</td>
    ...
    <div>
        <input type="button" class="btn" value="确定添加" onclick="add()">
    </div>
</div>
</div>
</body>
<script>
    function add()
    {
        ...
        var gddh = $("#gddh").val();
        var dzxx = $("#dzxx").val();
        if(username==""||password==""||gzdw==""||name==""||sfzh=="")
            alert("请将必填信息填写完整！");
        else
        {
            var msg ="确认添加？";
