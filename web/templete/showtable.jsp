...
<script>
    window.onload = function () {
        ...
        var xssh = <%=dcwj.getSfsh()%>;
        var bmsfsh = <%=dcwj.getBmsfsh()%>;
        if (xssh!=-1)
        {
            var htmltext="<td class='left'><span class='red'>*</span>形式审核意见</td>\n" +
                "            <td class='right' colspan='4'>\n" +
                "                <textarea readonly='readonly' name='suggest' cols='100' rows='5'><%=dcwj.getXsscyj()%></textarea>\n" +
                "            </td>";
            $("#xssh").html(htmltext);
        }
        if (bmsfsh!=-1)
        {
            var htmltext="<td class='left'><span class='red'>*</span>部门审核意见</td>\n" +
                "            <td class='right' colspan='4'>\n" +
                "                <textarea readonly='readonly' name='suggest' cols='100' rows='5'><%=dcwj.getBmshyj()%></textarea>\n" +
                "            </td>";
            $("#bmsh").html(htmltext);
        }
    };
...
<table border="1" align="center" width="70%">
    ...
    <tr>
        ...
        <td colspan="4"><input style="border: 0; width: 90%" dir="rtl" type="text" name="ztz" value="<%=dcwj.getJhztz()%>">万元</td>
    </tr>
    <tr>
    ...
    <tr id="xssh" align="center"></tr>
    <tr id="bmsh" align="center"></tr>
    </table>
</body>
</html>